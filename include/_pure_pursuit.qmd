...
If you are familiar with the "follow the carrot" analogy, pure pursuit control 
...
trajectory is an array of points, given two consecutive trajectory points 
P1(x1, y2) and P2(x2, y2), the goal point P(x, y) can be found as follows:
